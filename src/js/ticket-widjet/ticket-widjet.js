import ApiServer from "../api-connect/api-widjet";
import TicketCreation from "../widjet-structure/widjet-creation";
...
export default class TicketsWidget {
  ...
  constructor(container) {
    ...
    this.ticketBase = new ApiServer("http://localhost:7070/");
  ...
  get addOrEdit() {return this.#addOrEdit;}
  set addOrEdit(value) {this.#addOrEdit = value;}
  get currentTicket() {return this.#currentTicket;}
  set currentTicket(ticket) {this.#currentTicket = ticket;}
      ...
      if (this.addOrEdit === "add") {
        this.ticketBase.createTicket(formName, formDescription, (data) => {
          ...
          this.ticketsContainer.appendChild(
            TicketCreation.createCard(id, name, description, status, created)
          );
        });
